...
/** 
 * DAO for table "BASE_DATA".
*/
public class BaseDataDao extends AbstractDao<BaseData, String> {

    public static final String TABLENAME = "BASE_DATA";

    /**
     * Properties of entity BaseData.<br/>
    ...
    public BaseDataDao(DaoConfig config) {
        super(config);
    }
    
    public BaseDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BASE_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BASE_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BaseData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BaseData entity) {
        stmt.clearBindings();
    ...
    @Override
    public BaseData readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, BaseData entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(BaseData entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(BaseData entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BaseData entity) {
